							...
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										<h5>Total Users</h5>
										<h3 class="text-blue"><?=$userdetails->users()?></h3>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										<h5>Appointments</h5>
										<h3 class="text-blue"><?=$appointments->countappointment()?></h3>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										...
										<h3 class="text-blue"><?=$appointments->countapproveappointment()?></h3>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										...
										<h3 class="text-blue"><?=$appointments->countpendingappointment()?></h3>
									</div>
								</div>
							</div>
							<div class="col-xxl-3 col-sm-4 col-12">
								<div class="stats-tile">
									...
									<div class="sale-details">
										<h5>Conditions</h5>
										<h3 class="text-green"><?=$condition->countcondition()?></h3>
									</div>
								</div>
							</div>
							<!-- <div class="col-xxl-3 col-sm-4 col-12">
